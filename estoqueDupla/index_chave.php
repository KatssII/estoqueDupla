        ...
        <form action="edit_chave.php" method="post" id="formulario">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="" style="font-weight: bold; color: white">ULTIMA PESSOA A RETIRAR</label>
                        <input type="text" name="pessoaRetirada" id="pessoaRetirada" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="" style="font-weight: bold; color: white">DATA DA ULTIMA RETIRADA</label>
                        <input type="date" name="dataRetirada" id="dataRetirada" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="estado" style="font-weight: bold; color: white">ESTADO DA CHAVE</label>
